...
_TRANSLATIONS = {
    ...
    # ── 上传硬化（进度可见 / 续传 / 清理 / 退出确认）──────
    "⏳ {}（上传中 {}% · {}）":      {"en": "⏳ {} (uploading {}% · {})",     "zh": "⏳ {}（上传中 {}% · {}）"},
    "⏳ {}（排队中）":              {"en": "⏳ {} (queued)",                 "zh": "⏳ {}（排队中）"},
    "☁ 开始上传: {}":              {"en": "☁ Upload started: {}",          "zh": "☁ 开始上传: {}"},
    "☁ [{}] {}":                   {"en": "☁ [{}] {}",                     "zh": "☁ [{}] {}"},
    "☁ [{}] 上传中… {}%":          {"en": "☁ [{}] uploading… {}%",          "zh": "☁ [{}] 上传中… {}%"},
    "☁ 恢复未完成的上传: {}":       {"en": "☁ Resuming unfinished upload: {}", "zh": "☁ 恢复未完成的上传: {}"},
    "☁ 已恢复 {} 个未完成的上传任务": {"en": "☁ Resumed {} unfinished upload task(s)", "zh": "☁ 已恢复 {} 个未完成的上传任务"},
    "☁ 跳过恢复 {}: {}":            {"en": "☁ Skipped resuming {}: {}",     "zh": "☁ 跳过恢复 {}: {}"},
    "☁ {} 已在服务器上，无需重传: {}": {"en": "☁ {} is already on the server, no re-upload needed: {}", "zh": "☁ {} 已在服务器上，无需重传: {}"},
    "🧹 已清理上传残留临时文件 {} 个": {"en": "🧹 Cleaned up {} leftover upload temp file(s)", "zh": "🧹 已清理上传残留临时文件 {} 个"},
    "本地文件不存在":               {"en": "local files are gone",          "zh": "本地文件不存在"},
    "服务器地址已变更":             {"en": "server address changed",        "zh": "服务器地址已变更"},
    "已上传完成":                   {"en": "already uploaded",              "zh": "已上传完成"},
    "已在队列中":                   {"en": "already queued",                "zh": "已在队列中"},
    "上次进程中断前已入库":          {"en": "already stored before the last shutdown", "zh": "上次进程中断前已入库"},
    "POST 返回失败但服务器已入库":   {"en": "POST failed but the server already stored it", "zh": "POST 返回失败但服务器已入库"},
    "上传中断但服务器已入库":        {"en": "upload interrupted but the server already stored it", "zh": "上传中断但服务器已入库"},
    "服务器上已存在本次会话，按成功处理（{}）": {
        "en": "This session already exists on the server; treated as success ({})",
        "zh": "服务器上已存在本次会话，按成功处理（{}）",
    },
    "有 {} 个上传任务未完成，确定退出？未完成的任务将在下次启动时自动恢复。": {
        "en": "{} upload task(s) still unfinished. Quit anyway?\nThey will be resumed automatically on the next start.",
        "zh": "有 {} 个上传任务未完成，确定退出？未完成的任务将在下次启动时自动恢复。",
    },
    "发布时间:":                  {"en": "Published:",                      "zh": "发布时间:"},
