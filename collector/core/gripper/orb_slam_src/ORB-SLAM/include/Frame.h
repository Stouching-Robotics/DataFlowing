...
public:
    ...
    // Lightweight live timing used by the Fays runtime diagnostics.  These
    // stay enabled independently of REGISTER_TIMES so field tests can split
    // TrackStereo latency without enabling ORB-SLAM's bulk statistics files.
    double mKsqOrbWallMs = 0.0;
    double mKsqOrbLeftMs = 0.0;
    double mKsqOrbRightMs = 0.0;
    double mKsqStereoMs = 0.0;
    unsigned long mKsqLeftFeatures = 0;
    unsigned long mKsqRightFeatures = 0;
