...
{
    unique_lock<mutex> lock(mMutexAtlas);
    // Fix 4: Properly delete Map objects before clearing the set.
    // Original code commented out the delete loop, leaking Map objects on reset.
...
{
    // Fix 4: Properly delete bad Map objects instead of just clearing the set.
